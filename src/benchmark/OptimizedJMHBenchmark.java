...
/**
 * Optimized JMH benchmark for comparing sequential and parallel implementations
 * Configured for AMD Ryzen Threadripper 3990X with 64 cores (128 threads)
 * Designed to complete within a 5-hour time window
 */
...
public class OptimizedJMHBenchmark {

    // Using all original test images
    @Param({
    ...
    @Param({"1", "10", "50", "100", "500", "1000", "2147483647"})
